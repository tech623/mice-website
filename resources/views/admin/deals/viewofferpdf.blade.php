...
<div style="margin: auto;padding-left: 10px;padding-right: 10px;padding-bottom: 10px;">

    <div style="text-align:center;"><img src="{{ public_path('images/MiceLogo.png') }}" width="36%"><strong style="float:right;">Date : {{date('d M Y')}}</strong></div>
    <br><br>
    ...
    @else
        ...
        <table class="table-width">
            <thead><tr class="tr-ht1"><td><strong>Date</strong></td><td>{{ date('d M Y', strtotime($deal_data->event_start_date))}}</td>
            <td>{{ date('d M Y', strtotime($deal_data->event_end_date))}}</td></tr></thead>
            <tbody><tr class="tr-ht1"><td><strong>No. Of Rooms</strong></td><td>{{ $deal_data->number_of_rooms }}</td><td>Checkout</td></tr></tbody>
        </table>
        <br><br>
        ...
        @if($room_plan->count())
            <table class="table-width">
                <thead><tr class="tr-ht1"><th>SI</th><th>Room Type</th><th>Occupancy</th><th>Rates Per Night</th></tr></thead>
                <tbody>
                @foreach ($room_plan as $rplan)
                    <tr><td>{{$loop->iteration}}</td><td>{{$rplan->title}}</td><td>{{ucfirst($rplan->room_occupancy)}}</td>
    ...
    <table>
        <thead><tr class="tr-ht2"><th>S No.</th><th>Intimation regarding reduction in rooms received by MICE Hospitality Services Pvt. Ltd.</th>
        <th>Retention Charges if reduction is less than 5% </th><th>Retention Charges if reduction is 5% to 20% </th></tr></thead>
        <tbody>
            <tr class="tr-ht2"><td>1)</td><td>From the date of confirmation to 90 days from 1st check-in of conference/event</td><td>No charge</td>
            <td>25% charges, for the entire length stay, for the rooms being released</td>
            </tr>
            <tr class="tr-ht2"><td>2)</td><td>Between 89 and 60 days of the 1st check-in of conference/ event</td><td>25% charges, for the entire 
                length stay, for the rooms being released</td><td>50% charges, for the entire length stay, for the rooms being 
                released</td>
            </tr>
            <tr class="tr-ht2"><td>3)</td><td>Between 59 and 30 days of the 1st check-in of conference/event</td><td>50% charges, for the entire 
                length stay, for the rooms being released</td><td>100% charges, for the entire length stay, for the rooms being 
                released</td>
            </tr>
            <tr class="tr-ht2"><td>4)</td><td>29 days or less of the 1st check-in of the conference/ event, including “no-show”</td><td>
    ...
    <table>
        <thead><tr class="tr-ht2"><th>SL. No.</th><th>Cancellation Received by MICE Hospitality Services Pvt. Ltd.</th>
        <th>Cancellation Charge to be levied</th></tr></thead>
        <tbody>
            <tr class="tr-ht2"><td>1)</td><td>Between date of confirmation and 90 days of the check in of the conference</td><td>25% of the total 
                expected billing including accommodation and banquet arrangements.</td>
            </tr>
            <tr class="tr-ht2"><td>2)</td><td>Between 89 and 60 days of the check in of the conference</td><td>50 % of the total expected billing 
                including accommodation and banquet arrangements.</td>
            </tr>
            <tr class="tr-ht2"><td>3)</td><td>Between 59 and 30 days of the check in of the conference</td><td>75 % of the total expected billing 
                including accommodation and banquet arrangements.</td>
            </tr>
            <tr class="tr-ht2"><td>4)</td><td>29 days or less from the first check in of the conference</td><td>100% of the total expected billing 
                including accommodation and banquet arrangements</td>
            </tr>
        </tbody>
    </table>
    ...
    <br>For <strong>MICE Hospitality Services Pvt. Ltd.</strong><br><br><br><br><br>
