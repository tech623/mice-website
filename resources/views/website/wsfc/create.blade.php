...
<div class="row">
    <div class="newhcontainer col-md-12" style="background-image: url({{asset('images/imtex-back.png')}});">
        <div class="top-image">
            <img src="{{asset('images/Windergy-2025-logo-03.png')}}" alt="App Header" />
        </div>
    ...
    <div class="col-md-10 offset-md-1 mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="price-disclaimer">* The prices shown are early bird prices and valid till 31st October.</div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Windergy - Hotel Booking</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form id="imtex" method="POST" action="{{ route('registrationWindergyStore') }}">
                                    <div class="row">
