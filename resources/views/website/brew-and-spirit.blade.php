...
<div class="row">
    <div class="newhcontainer col-md-12" style="background-image: url({{asset('images/imtex-back.png')}});">
        <div class="top-image">
            <img src="{{asset('images/bns-logo-86.webp')}}" alt="App Header" />
        </div>
    ...
    <div class="col-md-10 offset-md-1 mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="price-disclaimer">* The prices shown are early bird prices and valid till 27 - 29 Navember, 2025 .</div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Brews & Spirits 2025 - Hotel Booking</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form id="imtex" method="POST" action="{{ route('registrationbrewSpiritStore') }}">
                                    <div class="row">
            ...
            <div class="card form-group card-clickable" id="card_${hotel.id}" data-name="${hotel.property_name}" data-location="${hotel.location}" data-metro="${hotel.near_to_metro_line}" style="width: 98%;" data-id="${hotel.id}">
                <div class="card-body">
                    ...
                    <p class="card-text text-muted" style="margin-bottom: 10px;">
                        ${hotel.distance_from_biec} Kms From KTPO
                    </p>
