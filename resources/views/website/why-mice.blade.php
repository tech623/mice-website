        ...
        <div class="row mb-5 mt-4 under-color d-none d-sm-flex" style="padding-bottom:10px">
            <div class="col justify-content-center d-flex borderRight">
                <a class="" href="{{route('conferences-meeting')}}">
                    <img src="{{asset('images/New Frame 36.svg')}}" alt=""   class="why-service-img" />
                </a>
            </div>
            <div class="col justify-content-center d-flex borderRight">
                <a class="" href="{{route('event-managment')}}">
                    <img src="{{asset('images/New Frame 35.svg')}}" alt=""   class="why-service-img" />
                </a>
            </div>
            <div class="col justify-content-center d-flex borderRight">
                <a class="" href="{{route('dayouts-service')}}">
                    <img src="{{asset('images/New Frame 37.svg')}}" alt=""   class="why-service-img" />
                </a>
            </div>
            <div class="col justify-content-center d-flex borderRight">
                <a class="" href="{{route('travel-managment')}}">
                    <img src="{{asset('images/New Frame 38.svg')}}" alt=""   class="why-service-img" />
                </a>
            </div>
            <div class="col justify-content-center d-flex borderRight">
                <a class="" href="{{route('tour-handling')}}">
                    <img src="{{asset('images/New Frame 57.svg')}}" alt=""   class="why-service-img" />
                </a>
            </div>
            <div class="col justify-content-center d-flex borderRight">
                <a class="" href="{{route('wedding-service')}}">
                    <img src="{{asset('images/New Frame 40.svg')}}" alt=""   class="why-service-img" />
                </a>
            </div>
            <div class="col justify-content-center d-flex">
                <a class="" href="{{route('partner-with-us')}}">
                    <img src="{{asset('images/New Frame 58.svg')}}" alt=""   class="why-service-img" />
                </a>
            </div>
        </div>
