...
<style>
    ...
    .card-clickable.active {
        border: 2px solid #F47E27;
        /* Border color when active (clicked) */
    }

    .fixed-col-md-7 {
        position: sticky;
        top: 200px;
        /* Adjust this value to align the top of the column */
        width: 100%;
        /* Make sure it takes full width within the parent container */
        height: 100vh;
        /* Adjust this value based on the height you want */
        overflow-y: auto;
        /* Ensure content scrolls if it exceeds the column's height */
    }
...
<div class="row">
    <div class="newhcontainer col-md-12" style="background-image: url({{asset('images/imtex-back.png')}});">
        <div class="top-image">
            <img src="{{asset('images/seafood-logo.jpg')}}" alt="App Header" />
        </div>
        <!-- <div class="bottom-images">
            <img src="{{asset('images/Windergy.gif')}}" alt="App Header" />
    ...
    <div class="col-md-10 offset-md-1 mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="price-disclaimer">* The prices shown are early bird prices and valid till 9 - 11 February, 2026 .</div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">World Seafood Congress 2026 - Hotel Booking</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form id="imtex" method="POST" action="{{ route('registrationSeaFoodyStore') }}">
                                    <div class="row">
...
<script>
        ...
        <div class="col-md-6">
            <div class="card form-group card-clickable" id="card_${hotel.id}" data-name="${hotel.property_name}" data-location="${hotel.location}" data-metro="${hotel.near_to_metro_line}" style="width: 98%;" data-id="${hotel.id}">
                <div class="card-body">
                    ...
                    <p class="card-text text-muted" style="margin-bottom: 10px; font-size:14px; text-align:justify;">
                        <strong>${hotel.property_name} - </strong>${hotel?.description}
                    </p>
                    ...
                    <p class="card-text text-muted" style="margin-bottom: 10px;">
                        ${hotel.distance_from_biec} Kms From Chennai Trade Center
                    </p>
                            ...
                            <div class="bd-callout bd-callout-info">
                                <div class="form-check" style="padding-left:0px">
                                    <label class="form-check-label text-muted" style="font-weight: 400; font-size: 13px;" for="single_${hotel.id}">
                                        Single occupancy ₹${hotel.single_bed_price} + ${hotel.taxes}% GST
                                    </label>
                                </div>
                                <div class="form-check" style="padding-left:0px">
                                    <label class="form-check-label text-muted" style="font-weight: 400; font-size: 13px;" for="double_${hotel.id}">
                                        Double occupancy ₹${hotel.double_bed_price} + ${hotel.taxes}% GST
                                    </label>
                                </div>
                            </div>
                        </div>
    ...
    $('.bed_type').on('change', function() {
        ...
        var desc = bed_type + " occupancy price: ₹" + filterHotelList[bed_type + '_bed_price'] + " +" + filterHotelList.taxes + "% GST";
        $('#hotelHelp').text(desc);
...
<script>
    ...
    $(document).ready(function() {
        $('#hotelSelect').on('change', function() {
            ...
            console.log(filterHotelList);
            var desc = "Single occupancy price: ₹" + filterHotelList.single_bed_price + " +" + filterHotelList.taxes + "% GST, Double occupancy price: ₹" + filterHotelList.double_bed_price + " +" + filterHotelList.taxes + "% GST";
            $('#hotelHelp').text(desc);
        });
    });
</script>
