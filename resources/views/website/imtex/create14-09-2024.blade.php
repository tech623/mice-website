...
<div class="row header-margin">
    ...
    <div class="col-md-10 offset-md-1 mt-5">
        <div class="card">
            <div class="card-header d-flex justify-content-center" style="font-weight: 600; font-size: 20px;">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">IMTEX 2025 – Hotel Booking</h5>
