@if($currentStep == 1)
<div class="card">
    <div class="card-body register-card-body mt-4 mb-5">
        <div class="text-center register-box-msg-header mb-3">Welcome! 👋</div>
        <p class="register-box-msg">Please enter your email address</p>
...
<div class="card">
    <div class="card-body register-card-body mt-4 mb-5">
        <h6 class="text-center register-box-msg-header">Looks like you’re new!</h6>
        <p class="register-box-msg">Please create an account</p>

        <div class="input-group mb-3">
            <input type="text" id="full_name" class="form-control @error('full_name') is-invalid @enderror" value="{{ old('full_name') }}" autocomplete="full_name" autofocus wire:model.defer="full_name" placeholder="Enter your Full Name" />
            @error('full_name')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="input-group mb-3">
            <input type="password" id="password" class="form-control @error('password') is-invalid @enderror" value="{{ old('password') }}" autocomplete="password" autofocus wire:model.defer="password" placeholder="Enter Password" />
            @error('password')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="input-group mb-3">
            <input type="password" id="confirm_password" class="form-control @error('confirm_password') is-invalid @enderror" value="{{ old('confirm_password') }}" autocomplete="confirm_password" autofocus wire:model.defer="confirm_password" placeholder="Enter Confirm Password" />
...
<div class="card">    
    ...
    <div class="card-body login-card-body mt-4 mb-5 text-center">
